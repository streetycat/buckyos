...
- `provider_instance_name` 是 Provider instance 的唯一名。
- `provider_type` 是可信部署类型，不是厂商名。常用值：`cloud_api`、`local_inference`、`proxy_unknown`。
- `provider_profile_id` 标识 Provider 渠道规则，例如 `openai`、`openrouter`、`claude`、`google-gemini`、`minimax`。
- `protocol_adapter_id` 由 Provider Profile 决定并随 inventory 返回，不在普通 instance settings 中复用 `provider_profile_id` 表达。
...
```json
{
  ...
  "params": {
    "key": "services/aicc/settings",
    "value": "{\"openai\":{\"enabled\":true,\"api_token\":\"sk-xxx\",\"instances\":[{\"provider_instance_name\":\"openai-primary\",\"provider_type\":\"cloud_api\",\"provider_profile_id\":\"openai\",\"base_url\":\"https://api.openai.com/v1\",\"timeout_ms\":60000,\"models\":[\"gpt-5.2\",\"gpt-5-mini\"],\"default_model\":\"gpt-5.2\",\"features\":[\"plan\",\"json_output\",\"tool_calling\",\"web_search\"]}]}}"
  },
...
```json
{
  ...
  "params": {
    "key": "services/aicc/settings",
    "json_path": "/openai",
    "value": "{\"enabled\":true,\"api_token\":\"sk-xxx\",\"instances\":[{\"provider_instance_name\":\"openai-primary\",\"provider_type\":\"cloud_api\",\"provider_profile_id\":\"openai\",\"base_url\":\"https://api.openai.com/v1\",\"timeout_ms\":60000,\"models\":[\"gpt-5.2\",\"gpt-5-mini\"],\"default_model\":\"gpt-5.2\",\"features\":[\"plan\",\"json_output\",\"tool_calling\",\"web_search\"]}]}"
  },
